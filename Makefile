...
test-ios:
	...
	@pushd Tests > /dev/null; xcodebuild test -workspace SRGUserData-tests.xcworkspace -scheme SRGUserData-tests -destination 'platform=iOS Simulator,name=iPhone 11' 2> /dev/null
	@echo "... done.\n"
