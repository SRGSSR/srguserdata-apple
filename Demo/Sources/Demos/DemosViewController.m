...
- (void)refresh
{
    ...
    NSArray<NSString *> *mediaURNs = [SRGUserData.currentUserData.store performMainThreadReadTask:^id _Nonnull(NSManagedObjectContext * _Nonnull managedObjectContext) {
