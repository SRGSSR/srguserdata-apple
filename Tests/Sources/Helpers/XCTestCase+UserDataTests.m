...
@implementation XCTestCase (UserDataTests)

- (XCTestExpectation *)udt_expectationForNotification:(NSNotificationName)notificationName object:(id)objectToObserve handler:(XCNotificationExpectationHandler)handler
{
